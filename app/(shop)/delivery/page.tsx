  ...
  return (
    <main className="container space-y-8 py-12">
      <section className="space-y-4">
        ...
        <h1 className="font-serif text-4xl">Commander en confiance, etre livre clairement</h1>
        <p className="max-w-3xl text-muted-foreground">
          Legend Farm Shop affiche ses zones de livraison, ses frais et ses
          creneaux de maniere plus lisible pour eviter les surprises au moment de
          la commande.
        </p>
      </section>
